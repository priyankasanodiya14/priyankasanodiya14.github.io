...
// *=============================== github calender ==================================
GitHubCalendar(".calendar", "Priyanka");

// or enable responsive functionality:
GitHubCalendar(".calendar", "Priyanka", { responsive: true });
...
function NewTab() {
  window.open(
    "https://drive.google.com/file/d/1kU4WynAb4upq5f6HPubCV5nHsEELnHWE/view?usp=sharing",
    "_blank"
  );
}
